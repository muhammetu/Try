...
// @duzenleme
// Messenger uzerinden SQL Injection engeli.
...
void MessengerManager::__RemoveFromList(MessengerManager::keyA account, MessengerManager::keyA companion)
{
	...
	// @duzenleme karakter listeden silindiginde karsi tarafta silinmiyor.
	...
	// @duzenleme karakter listeden silindiginde karsi tarafa paket gitmiyor.
	LPCHARACTER tch = CHARACTER_MANAGER::Instance().FindPC(companion.c_str());
	if (tch && tch->GetDesc())
	{
...
void MessengerManager::RemoveFromList(MessengerManager::keyA account, MessengerManager::keyA companion)
{
	...
	// // @duzenleme karakter listeden silindiginde karsi taraftan silinmeyebiliyor.
