...
template <typename T> class cache
{
	public:
		...
		// datayi mysqle yolladiktan sonra burda degisiklik yaptin mi
		// ve
		// mysqle son yollayisinin uzerinden m_expireTime gecti mi?
		{
		...
		bool CheckTimeout()
		// cacheyi ekledigin/degistirdigin/veri cektigin zamanin uerinden m_expireTime gecti mi?
		{
