...
CTextureSet* CTerrainImpl::ms_pSnowTextureSet = nullptr;
CTextureSet* CTerrainImpl::ms_pDesertTextureSet = nullptr;
#endif
...
#ifdef ENABLE_ENVIRONMENT_EFFECT_OPTION
void CTerrainImpl::SetSnowTextureSet(CTextureSet* pTextureSet)
{
	static CTextureSet s_EmptyTextureSet;

	if (!pTextureSet)
		ms_pSnowTextureSet = &s_EmptyTextureSet;
	else
		ms_pSnowTextureSet = pTextureSet;
}

CTextureSet* CTerrainImpl::GetSnowTextureSet()
{
	if (!ms_pSnowTextureSet)
		SetSnowTextureSet(nullptr);

	return ms_pSnowTextureSet;
}

void CTerrainImpl::SetDesertTextureSet(CTextureSet* pTextureSet)
{
	static CTextureSet s_EmptyTextureSet;

	if (!pTextureSet)
		ms_pDesertTextureSet = &s_EmptyTextureSet;
	else
		ms_pDesertTextureSet = pTextureSet;
}

CTextureSet* CTerrainImpl::GetDesertTextureSet()
{
	if (!ms_pDesertTextureSet)
		SetDesertTextureSet(nullptr);

	return ms_pDesertTextureSet;
}
#endif
...
{
	Tracenf("LoadRawHeightMapFile %s ", c_szFileName);
