...
public:
	...
	static CTextureSet* GetTextureSet();
		...
		static void				SetDesertTextureSet(CTextureSet* pTextureSet);
		static CTextureSet* GetDesertTextureSet();
#endif
...
protected:
	...
	static CTextureSet* ms_pDesertTextureSet;
#endif
...
#ifdef ENABLE_ENVIRONMENT_EFFECT_OPTION
	DWORD					GetNumSnowTextures() { return ms_pSnowTextureSet->GetTextureCount(); }
	TTerrainTexture& GetSnowTexture(const long& c_rlTextureNum) { return ms_pSnowTextureSet->GetTexture(c_rlTextureNum); }

	DWORD					GetNumDesertTextures() { return ms_pDesertTextureSet->GetTextureCount(); }
	TTerrainTexture& GetDesertTexture(const long& c_rlTextureNum) { return ms_pDesertTextureSet->GetTexture(c_rlTextureNum); }
#endif
