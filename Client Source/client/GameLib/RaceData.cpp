...
CGraphicThing* CRaceData::RegisterMotionData(WORD wMotionMode, WORD wMotionIndex, const char* c_szFileName, BYTE byPercentage, bool bHaveSound)
{
	CRaceMotionData* pRaceMotionData = CRaceMotionData::New();
	if (!pRaceMotionData->LoadMotionData(c_szFileName, bHaveSound))
	{
