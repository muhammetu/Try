...
public:
	...
	bool SetRace(DWORD eRace, bool isIntro=false);
#else
...
public:
	...
	DWORD AttachEffectByName(DWORD dwParentPartIndex, const char * c_pszBoneName, const char * c_pszEffectFileName, bool ignoreFrustum=false);
#else
	...
	// Uyarlanmadi dikkat !
#ifdef ENABLE_SKILL_COLOR_SYSTEM
	DWORD AttachEffectByID(DWORD dwParentPartIndex, const char* c_pszBoneName, DWORD dwEffectID, const D3DXVECTOR3* c_pv3Position = NULL, DWORD* dwSkillColor = NULL, bool ignoreFrustum = false, float fParticleScale = 1.0f, const D3DXVECTOR3* c_pv3MeshScale = NULL);
#else
	DWORD AttachEffectByID(DWORD dwParentPartIndex, const char* c_pszBoneName, DWORD dwEffectID, const D3DXVECTOR3* c_pv3Position = NULL, bool ignoreFrustum = false);
#endif
...
#ifdef ENABLE_BOSS_ON_MINIMAP
public:
	void SetRaceFlag(DWORD dwRaceFlag);
protected:
	DWORD	m_dwRaceFlag;
#endif
...
protected:
	...
	// @duzenleme
	// saman ve lycan karakterin atak kacirmasiyla alakali.
...
public:
	...
	void SetQuiverEffectID(DWORD dwEffectID);
...
public:
	void SetRenderTarget(bool f) { m_bRenderTarget = f; }
	bool IsRenderTarget() { return m_bRenderTarget; }
protected:
