...
void CMapOutdoor::CreateCharacterShadowTexture()
{
	...
	if (FAILED(ms_lpd3dDevice->CreateDepthStencilSurface(m_wShadowMapSize, m_wShadowMapSize, D3DFMT_D24S8, D3DMULTISAMPLE_NONE, &m_lpCharacterShadowMapDepthSurface)))
	{
