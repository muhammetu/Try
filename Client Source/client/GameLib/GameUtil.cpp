...
bool DetectCollisionDynamicSphereVSDynamicSphereScale(const CDynamicSphereInstance& c_rSphere1, const CDynamicSphereInstance& c_rSphere2, const float fScale)
{
	float r = c_rSphere1.fRadius + (c_rSphere2.fRadius * fScale);
	float rsq = r * r;
