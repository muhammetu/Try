...
bool CRaceMotionData::LoadMotionData(const char* c_szFileName, bool bHaveSound)
{
	...
	int bNoEffectCheck = 0;

	if (!rkTextFileLoader.GetTokenInteger("noeffectcheck", &bNoEffectCheck))
		bNoEffectCheck = 0;
	...
	if (bNoEffectCheck == 0 && bHaveSound == true)
	{
