...
bool CItemData::HasRealIcon()
{
	return m_strIconFileName.empty() == false && CResourceManager::Instance().IsFileExist(m_strIconFileName.c_str());
}
...
const char* CItemData::GetUseTypeString() const
{
...
#ifdef ENABLE_COSTUME_ATTR_SWITCH
	...
	case USE_ADD_AURA_ATTRIBUTE:
		return DEF_STR(USE_ADD_AURA_ATTRIBUTE);
	case USE_ADD_AURA_FIVE_ATTRIBUTE:
		return DEF_STR(USE_ADD_AURA_FIVE_ATTRIBUTE);
	case USE_CHANGE_AURA_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_AURA_ATTRIBUTE);
#endif
#ifdef ENABLE_MOUNT_COSTUME_SYSTEM
	case USE_ADD_MOUNT_ATTRIBUTE:
		return DEF_STR(USE_ADD_MOUNT_ATTRIBUTE);
	case USE_CHANGE_MOUNT_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_MOUNT_ATTRIBUTE);
#endif
#ifdef ENABLE_WEAPON_COSTUME_SYSTEM
	case USE_ADD_WEAPON_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_ADD_WEAPON_COSTUME_ATTRIBUTE);
	case USE_CHANGE_WEAPON_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_WEAPON_COSTUME_ATTRIBUTE);
#endif
#ifdef ENABLE_NEW_EQUIPMENT_SYSTEM
	case USE_ADD_BELT_ATTRIBUTE:
		return DEF_STR(USE_ADD_BELT_ATTRIBUTE);
	case USE_CHANGE_BELT_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_BELT_ATTRIBUTE);
#endif
#ifdef ENABLE_HAIR_COSTUME_ATTRIBUTE
	case USE_ADD_HAIR_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_ADD_HAIR_COSTUME_ATTRIBUTE);
	case USE_CHANGE_HAIR_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_HAIR_COSTUME_ATTRIBUTE);

#endif
#ifdef ENABLE_BODY_COSTUME_ATTRIBUTE
	case USE_ADD_BODY_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_ADD_BODY_COSTUME_ATTRIBUTE);
	case USE_CHANGE_BODY_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_BODY_COSTUME_ATTRIBUTE);
#endif
#ifdef ENABLE_SHINING_ITEM_SYSTEM
	case USE_ADD_ACCE_SHINING_ATTRIBUTE:
		return DEF_STR(USE_ADD_ACCE_SHINING_ATTRIBUTE);
	case USE_CHANGE_ACCE_SHINING_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_ACCE_SHINING_ATTRIBUTE);
	case USE_ADD_SOUL_SHINING_ATTRIBUTE:
		return DEF_STR(USE_ADD_SOUL_SHINING_ATTRIBUTE);
	case USE_ADD_SOUL_SHINING_FIVE_ATTRIBUTE:
		return DEF_STR(USE_ADD_SOUL_SHINING_FIVE_ATTRIBUTE);
	case USE_CHANGE_SOUL_SHINING_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_SOUL_SHINING_ATTRIBUTE);
#endif
#ifdef ENABLE_MOUNT_COSTUME_SYSTEM
	case USE_ADD_FIVE_MOUNT_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_MOUNT_ATTRIBUTE);
#endif
#ifdef ENABLE_WEAPON_COSTUME_SYSTEM
	case USE_ADD_FIVE_WEAPON_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_WEAPON_COSTUME_ATTRIBUTE);
#endif
#ifdef ENABLE_NEW_EQUIPMENT_SYSTEM
	case USE_ADD_FIVE_BELT_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_BELT_ATTRIBUTE);
#endif
#ifdef ENABLE_HAIR_COSTUME_ATTRIBUTE
	case USE_ADD_FIVE_HAIR_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_HAIR_COSTUME_ATTRIBUTE);
#endif
#ifdef ENABLE_BODY_COSTUME_ATTRIBUTE
	case USE_ADD_FIVE_BODY_COSTUME_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_BODY_COSTUME_ATTRIBUTE);
#endif
#ifdef ENABLE_SHINING_ITEM_SYSTEM
	case USE_ADD_FIVE_ACCE_SHINING_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_ACCE_SHINING_ATTRIBUTE);
#endif
#ifdef ENABLE_CAKRA_ITEM_SYSTEM
	case USE_ADD_CAKRA_ITEM_ATTRIBUTE:
		return DEF_STR(USE_ADD_CAKRA_ITEM_ATTRIBUTE);
	case USE_ADD_FIVE_CAKRA_ITEM_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_CAKRA_ITEM_ATTRIBUTE);
	case USE_CHANGE_CAKRA_ITEM_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_CAKRA_ITEM_ATTRIBUTE);
#endif
#ifdef ENABLE_EXTENDED_PET_ITEM
	case USE_ADD_PET_ITEM_ATTRIBUTE:
		return DEF_STR(USE_ADD_PET_ITEM_ATTRIBUTE);
	case USE_ADD_FIVE_PET_ITEM_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_PET_ITEM_ATTRIBUTE);
	case USE_CHANGE_PET_ITEM_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_PET_ITEM_ATTRIBUTE);
#endif
#ifdef ENABLE_SEBNEM_ITEM_SYSTEM
	case USE_ADD_SEBNEM_ITEM_ATTRIBUTE:
		return DEF_STR(USE_ADD_SEBNEM_ITEM_ATTRIBUTE);
	case USE_ADD_FIVE_SEBNEM_ITEM_ATTRIBUTE:
		return DEF_STR(USE_ADD_FIVE_SEBNEM_ITEM_ATTRIBUTE);
	case USE_CHANGE_SEBNEM_ITEM_ATTRIBUTE:
		return DEF_STR(USE_CHANGE_SEBNEM_ITEM_ATTRIBUTE);
#endif
	}
...
long long CItemData::GetIBuyItemPrice() const
{
	return m_ItemTable.llIBuyItemPrice;
}

long long CItemData::GetISellItemPrice() const
{
	return m_ItemTable.llISellItemPrice;
}
#else
