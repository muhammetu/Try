...
// CSkyObject
/////////////////////////////////////////////////////////////////////////
CSkyObject::CSkyObject() : m_fCloudScaleX(0), m_fCloudScaleY(0), m_fCloudHeight(0), m_fCloudTextureScaleX(0), m_fCloudTextureScaleY(0), m_fCloudScrollSpeedU(0), m_fCloudScrollSpeedV(0),
m_v3Position(0.0f, 0.0f, 0.0f),
m_fScaleX(1.0f),
m_fScaleY(1.0f),
m_fScaleZ(1.0f), m_ucRenderMode(0)
{
...
void CSkyBox::Refresh()
{
	...
	else if (m_ucRenderMode == CSkyObject::SKY_RENDER_MODE_TEXTURE)
	{
		...
		////// Face 5: BOTTOM
		// @duzenleme bottom skyboxu gozukmuyodu.
		// v3QuadPoints[0] = D3DXVECTOR3(1.0f, -1.0f, -1.0f);
		// v3QuadPoints[1] = D3DXVECTOR3(1.0f, 1.0f, -1.0f);
		// v3QuadPoints[2] = D3DXVECTOR3(-1.0f, -1.0f, -1.0f);
		// v3QuadPoints[3] = D3DXVECTOR3(-1.0f, 1.0f, -1.0f);
