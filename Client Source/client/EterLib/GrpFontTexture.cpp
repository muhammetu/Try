...
void CGraphicFontTexture::Destroy()
{
	...
	for (auto const& tex : m_pFontTextureVector)
		delete tex; // TODO: Use smart pointer for this
...
bool CGraphicFontTexture::Create(const std::string& fontName, int fontSize, bool bItalic)
{
	Destroy();
...
CGraphicFontTexture::TCharacterInfomation* CGraphicFontTexture::GetCharacterInfomation(wchar_t code)
{
...
CGraphicFontTexture::TCharacterInfomation* CGraphicFontTexture::UpdateCharacterInfomation(wchar_t code)
{
	HDC hDC = m_dib.GetDCHandle();
	SelectObject(hDC, m_hFont);

	wchar_t keyValue = code;
