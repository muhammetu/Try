...
namespace UI
{
	...
	public:
		...
		void			SetLimitBias(long l, long t, long r, long b)
		{
			m_limitBiasRect.left = l, m_limitBiasRect.top = t, m_limitBiasRect.right = r, m_limitBiasRect.bottom = b;
		}
