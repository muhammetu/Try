...
namespace UI
{
	...
	public:
		...
		float		PrepareClipRect(bool getRight, CWindow* pFirstWindow, CWindow* pSecondWindow, bool isSlot = false, DWORD slotWidth = 0, DWORD slotHeight = 0, DWORD slotYParameter = 0);
