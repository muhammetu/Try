...
PyObject* wndMgrGetParent(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", pWin->GetParent());
}
...
PyObject* wndMgrGetWindowRectNEW(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWin;
	if (!PyTuple_GetWindow(poArgs, 0, &pWin))
		return Py_BuildException();
...
PyObject* wndMgrSetLimitBias(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (!PyTuple_GetInteger(poArgs, 1, &l))
		return Py_BuildException();
	int t;
	if (!PyTuple_GetInteger(poArgs, 2, &t))
		return Py_BuildException();
	int r;
	if (!PyTuple_GetInteger(poArgs, 3, &r))
		return Py_BuildException();
	int b;
	if (!PyTuple_GetInteger(poArgs, 4, &b))
		return Py_BuildException();

	pWin->SetLimitBias(l, t, r, b);
	return Py_BuildNone();
}
...
PyObject* wndMgrSetEvolutionButton(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	...
	UI::CSlotWindow* pSlotWin = (UI::CSlotWindow*)pWindow;
	pSlotWin->SetEvolutionButton(iSlotIndex, szUpImageName, szOverImageName, szDownImageName, szDisableImageName, iLeftButtonEnable, iRightButtonEnable);

	return Py_BuildNone();
}

PyObject* wndMgrEnableEvolutionButton(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	...
	UI::CSlotWindow* pSlotWin = (UI::CSlotWindow*)pWindow;
	pSlotWin->EnableEvolutionButton(iSlotIndex);

	return Py_BuildNone();
}

PyObject* wndMgrDisableEvolutionButton(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	...
	UI::CSlotWindow* pSlotWin = (UI::CSlotWindow*)pWindow;
	pSlotWin->DisableEvolutionButton(iSlotIndex);
...
PyObject* wndMgrIsActiveEffect(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWin;
	if (!PyTuple_GetWindow(poArgs, 0, &pWin))
		return Py_BuildException();
	...
	UI::CSlotWindow* pSlotWin = (UI::CSlotWindow*)pWin;
	return Py_BuildValue("i", pSlotWin->IsActiveEffect(iSlotIndex));
}
...
PyObject* wndMgrGetSlotPosition(PyObject* poSelf, PyObject* poArgs)
{
	...
	int x, y;
	UI::CSlotWindow* pSlotWin = (UI::CSlotWindow*)pWin;
	pSlotWin->GetSlotPosition(iIndex, x, y);
...
PyObject* wndMgrGetSlotItemVnum(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWin;
	if (!PyTuple_GetWindow(poArgs, 0, &pWin))
		return Py_BuildException();
	...
	UI::CSlotWindow* pSlotWin = (UI::CSlotWindow*)pWin;
	return Py_BuildValue("i", pSlotWin->GetSlotItemVnum(iSlotNumber));
}
...
PyObject* wndMgrActivateEffect(PyObject* poSelf, PyObject* poArgs)
{
	...
	UI::CSlotWindow* pSlotWin = (UI::CSlotWindow*)pWin;
	pSlotWin->ActivateEffect(iSlotIndex, iColorType);
	return Py_BuildNone();
}
...
PyObject* wndMgrSetSlotHighlightedGreeen(PyObject* poSelf, PyObject* poArgs)
{
	...
	pSlotWin->SetSlotHighlightedGreeen(iSlotIndex, iSlotColor);
	return Py_BuildNone();
}
...
PyObject* wndMgrDisableSlotHighlightedGreen(PyObject* poSelf, PyObject* poArgs)
{
	...
	UI::CSlotWindow* pSlotWin = (UI::CSlotWindow*)pWin;
	pSlotWin->DisableSlotHighlightedGreen(iSlotIndex, iSlotColor);
	return Py_BuildNone();
}
...
PyObject * wndButtonOver(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (pWindow->IsType(UI::CButton::Type()))
		((UI::CButton*)pWindow)->Over();
	else if (pWindow->IsType(UI::CRadioButton::Type()))
		((UI::CRadioButton*)pWindow)->Over();

	return Py_BuildNone();
}
#endif
PyObject * wndCallFunction(PyObject * poSelf, PyObject * poArgs)
{
	UI::CWindow * pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	BYTE funcType;
	if (!PyTuple_GetInteger(poArgs, 1, &funcType))
		return Py_BuildException();

	switch (funcType)
	{
	case 0:
		pWindow->OnMouseOverIn();
		break;
	case 1:
		pWindow->OnMouseOverOut();
		break;
...
void initwndMgr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetWindowRectNEW",			wndMgrGetWindowRectNEW,				METH_VARARGS },
		...
		{ "IsActiveEffect",				wndMgrIsActiveEffect,				METH_VARARGS },
...
#ifdef ENABLE_ITEM_EVOLUTION_SYSTEM
		{ "SetEvolutionButton",				wndMgrSetEvolutionButton,				METH_VARARGS },
		{ "EnableEvolutionButton",			wndMgrEnableEvolutionButton,			METH_VARARGS },
		{ "DisableEvolutionButton",			wndMgrDisableEvolutionButton,			METH_VARARGS },
#endif
		...
		{ "GetSlotItemVnum",			wndMgrGetSlotItemVnum,				METH_VARARGS },
...
#endif
		{ "CallFunction",				wndCallFunction,						METH_VARARGS },
		{ NULL,							NULL,								NULL },
	};
	...
	PyModule_AddIntConstant(poModule, "COLOR_TYPE_DARK", UI::COLOR_TYPE_DARK);
