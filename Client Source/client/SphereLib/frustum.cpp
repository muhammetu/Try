...
ViewState Frustum::ViewVolumeTest(const Vector3d &c_v3Center,const float c_fRadius, BYTE frustumType) const
{
	if (m_bUsingSphere[frustumType])
	{
		D3DXVECTOR3 v(
				c_v3Center.x-m_v3Center[frustumType].x,
				c_v3Center.y-m_v3Center[frustumType].y,
				c_v3Center.z-m_v3Center[frustumType].z);

		if ((c_fRadius + m_fRadius[frustumType]) * (c_fRadius + m_fRadius[frustumType]) < D3DXVec3LengthSq(&v))
		{
			return VS_OUTSIDE;
		}
	}
	...
	for(i=0;i<count;i++)
	{
		distance[i] = D3DXPlaneDotCoord(&m_plane[frustumType][i],&center);
...
void Frustum::BuildViewFrustum(D3DXMATRIX & mat, BYTE frustumType)
{
	m_bUsingSphere[frustumType] = false;
	m_plane[frustumType][0] = D3DXPLANE(          mat._13,           mat._23,           mat._33,           mat._43);
	m_plane[frustumType][1] = D3DXPLANE(mat._14 - mat._13, mat._24 - mat._23, mat._34 - mat._33, mat._44 - mat._43);
	m_plane[frustumType][2] = D3DXPLANE(mat._14 + mat._11, mat._24 + mat._21, mat._34 + mat._31, mat._44 + mat._41);
	m_plane[frustumType][3] = D3DXPLANE(mat._14 - mat._11, mat._24 - mat._21, mat._34 - mat._31, mat._44 - mat._41);
	m_plane[frustumType][4] = D3DXPLANE(mat._14 + mat._12, mat._24 + mat._22, mat._34 + mat._32, mat._44 + mat._42);
	m_plane[frustumType][5] = D3DXPLANE(mat._14 - mat._12, mat._24 - mat._22, mat._34 - mat._32, mat._44 - mat._42);

	for(int i=0;i<6;i++)
		D3DXPlaneNormalize(&m_plane[frustumType][i],&m_plane[frustumType][i]);
}

void Frustum::BuildViewFrustum2(D3DXMATRIX & mat, float fNear, float fFar, float fFov, float fAspect, const D3DXVECTOR3 & vCamera, const D3DXVECTOR3 & vLook, BYTE frustumType)
{
	...
	D3DXVECTOR3 PQ = P-Q;
	m_fRadius[frustumType] = D3DXVec3Length(&PQ);
	m_v3Center[frustumType] = vCamera + vLook * (fNear+fViewLen*0.5f);
	BuildViewFrustum(mat, frustumType);
	m_bUsingSphere[frustumType] = true;
}
#else
