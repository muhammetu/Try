...
public:
	typedef struct SMeshData
	{
		...
		SMeshData() : byBillboardType(0), bBlendingEnable(0), byBlendingSrcType(0), byBlendingDestType(0), bTextureAlphaEnable(0), byColorOperationType(0), bTextureAnimationLoopEnable(0), fTextureAnimationFrameDelay(0), dwTextureAnimationStartFrame(0)
		{
