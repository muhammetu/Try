...
bool CPythonSkill::RegisterSkillDesc(const char* c_szFileName)
{
	...
	for (DWORD i = 0; i < textFileLoader.GetLineCount(); ++i)
	{
		...
		// Name
		{
			...
			if (rSkillData.GradeData[3].strName.empty())
				rSkillData.GradeData[3].strName = TokenVector[DESC_TOKEN_TYPE_NAME1];
#endif
#ifdef ENABLE_EXPERT_SKILL
			if (rSkillData.GradeData[4].strName.empty())
				rSkillData.GradeData[4].strName = TokenVector[DESC_TOKEN_TYPE_NAME1];
			if (rSkillData.GradeData[5].strName.empty())
				rSkillData.GradeData[5].strName = TokenVector[DESC_TOKEN_TYPE_NAME1];
			if (rSkillData.GradeData[6].strName.empty())
				rSkillData.GradeData[6].strName = TokenVector[DESC_TOKEN_TYPE_NAME1];
#endif
		}
...
{
	m_SkillTypeIndexMap.emplace(std::string("none"), SKILL_TYPE_NONE);
	m_SkillTypeIndexMap.emplace(std::string("active"), SKILL_TYPE_ACTIVE);
	m_SkillTypeIndexMap.emplace(std::string("support"), SKILL_TYPE_SUPPORT);
	m_SkillTypeIndexMap.emplace(std::string("guild"), SKILL_TYPE_GUILD);
	m_SkillTypeIndexMap.emplace(std::string("horse"), SKILL_TYPE_HORSE);
	m_SkillTypeIndexMap.emplace(std::string("warrior"), SKILL_TYPE_ACTIVE);
	m_SkillTypeIndexMap.emplace(std::string("assassin"), SKILL_TYPE_ACTIVE);
	m_SkillTypeIndexMap.emplace(std::string("sura"), SKILL_TYPE_ACTIVE);
	m_SkillTypeIndexMap.emplace(std::string("shaman"), SKILL_TYPE_ACTIVE);
	m_SkillTypeIndexMap.emplace(std::string("passive"), SKILL_TYPE_ACTIVE);
#ifdef ENABLE_WOLFMAN_CHARACTER
	m_SkillTypeIndexMap.emplace(std::string("78skill"), SKILL_TYPE_ACTIVE);
	m_SkillTypeIndexMap.emplace(std::string("wolfman"), SKILL_TYPE_ACTIVE);
#endif

	m_SkillAttributeIndexMap.emplace(std::string("NEED_POISON_BOTTLE"), SKILL_ATTRIBUTE_NEED_POISON_BOTTLE);
	m_SkillAttributeIndexMap.emplace(std::string("NEED_EMPTY_BOTTLE"), SKILL_ATTRIBUTE_NEED_EMPTY_BOTTLE);
	m_SkillAttributeIndexMap.emplace(std::string("CAN_USE_IF_NOT_ENOUGH"), SKILL_ATTRIBUTE_CAN_USE_IF_NOT_ENOUGH);
	m_SkillAttributeIndexMap.emplace(std::string("FAN_RANGE"), SKILL_ATTRIBUTE_FAN_RANGE);
	m_SkillAttributeIndexMap.emplace(std::string("NEED_CORPSE"), SKILL_ATTRIBUTE_NEED_CORPSE);
	m_SkillAttributeIndexMap.emplace(std::string("NEED_TARGET"), SKILL_ATTRIBUTE_NEED_TARGET);
	m_SkillAttributeIndexMap.emplace(std::string("TOGGLE"), SKILL_ATTRIBUTE_TOGGLE);
	m_SkillAttributeIndexMap.emplace(std::string("WEAPON_LIMITATION"), SKILL_ATTRIBUTE_WEAPON_LIMITATION);
	m_SkillAttributeIndexMap.emplace(std::string("MELEE_ATTACK"), SKILL_ATTRIBUTE_MELEE_ATTACK);
	m_SkillAttributeIndexMap.emplace(std::string("CHARGE_ATTACK"), SKILL_ATTRIBUTE_CHARGE_ATTACK);
	m_SkillAttributeIndexMap.emplace(std::string("USE_HP"), SKILL_ATTRIBUTE_USE_HP);
	m_SkillAttributeIndexMap.emplace(std::string("CAN_CHANGE_DIRECTION"), SKILL_ATTRIBUTE_CAN_CHANGE_DIRECTION);
	m_SkillAttributeIndexMap.emplace(std::string("STANDING_SKILL"), SKILL_ATTRIBUTE_STANDING_SKILL);
	m_SkillAttributeIndexMap.emplace(std::string("ONLY_FOR_ALLIANCE"), SKILL_ATTRIBUTE_ONLY_FOR_ALLIANCE);
	m_SkillAttributeIndexMap.emplace(std::string("CAN_USE_FOR_ME"), SKILL_ATTRIBUTE_CAN_USE_FOR_ME);
	m_SkillAttributeIndexMap.emplace(std::string("ATTACK_SKILL"), SKILL_ATTRIBUTE_ATTACK_SKILL);
	m_SkillAttributeIndexMap.emplace(std::string("MOVING_SKILL"), SKILL_ATTRIBUTE_MOVING_SKILL);
	m_SkillAttributeIndexMap.emplace(std::string("HORSE_SKILL"), SKILL_ATTRIBUTE_HORSE_SKILL);
	m_SkillAttributeIndexMap.emplace(std::string("TIME_INCREASE_SKILL"), SKILL_ATTRIBUTE_TIME_INCREASE_SKILL);
	m_SkillAttributeIndexMap.emplace(std::string("PASSIVE"), SKILL_ATTRIBUTE_PASSIVE);
	m_SkillAttributeIndexMap.emplace(std::string("CANNOT_LEVEL_UP"), SKILL_ATTRIBUTE_CANNOT_LEVEL_UP);
	m_SkillAttributeIndexMap.emplace(std::string("ONLY_FOR_GUILD_WAR"), SKILL_ATTRIBUTE_ONLY_FOR_GUILD_WAR);
	m_SkillAttributeIndexMap.emplace(std::string("CIRCLE_RANGE"), SKILL_ATTRIBUTE_CIRCLE_RANGE);
	m_SkillAttributeIndexMap.emplace(std::string("SEARCH_TARGET"), SKILL_ATTRIBUTE_SEARCH_TARGET);

	m_SkillNeedWeaponIndexMap.emplace(std::string("SWORD"), SKILL_NEED_WEAPON_SWORD);
	m_SkillNeedWeaponIndexMap.emplace(std::string("DAGGER"), SKILL_NEED_WEAPON_DAGGER);
	m_SkillNeedWeaponIndexMap.emplace(std::string("BOW"), SKILL_NEED_WEAPON_BOW);
	m_SkillNeedWeaponIndexMap.emplace(std::string("TWO_HANDED"), SKILL_NEED_WEAPON_TWO_HANDED);
	m_SkillNeedWeaponIndexMap.emplace(std::string("DOUBLE_SWORD"), SKILL_NEED_WEAPON_DOUBLE_SWORD);
	m_SkillNeedWeaponIndexMap.emplace(std::string("BELL"), SKILL_NEED_WEAPON_BELL);
	m_SkillNeedWeaponIndexMap.emplace(std::string("FAN"), SKILL_NEED_WEAPON_FAN);
	m_SkillNeedWeaponIndexMap.emplace(std::string("ARROW"), SKILL_NEED_WEAPON_ARROW);
	m_SkillNeedWeaponIndexMap.emplace(std::string("EMPTY_HAND"), SKILL_NEED_WEAPON_EMPTY_HAND);
	m_SkillNeedWeaponIndexMap.emplace(std::string("MOUNT_SPEAR"), SKILL_NEED_WEAPON_MOUNT_SPEAR);
#ifdef ENABLE_WOLFMAN_CHARACTER
	m_SkillNeedWeaponIndexMap.emplace(std::string("CLAW"), SKILL_NEED_WEAPON_CLAW);
#endif
...
DWORD CPythonSkill::SSkillData::GetSkillMotionIndex(int iGrade)
{
	...
	{
#ifdef ENABLE_SAGE_SKILL
		if (CPythonPlayer::SKILL_SAGE_MASTER <= iGrade)
		{
			return GradeData[CPythonPlayer::SKILL_PERFECT_MASTER].wMotionIndex;
		}
		else
#endif
...
PyObject* skillGetGradeData(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", c_pSkillData->GradeData[iGradeIndex].wMotionIndex); // crash
}
...
PyObject* skillGetDuration(PyObject* poSelf, PyObject* poArgs)
{
	...
	case 110:
	case 111:
		return Py_BuildValue("i", INT_MAX);
	}
#endif
...
#ifdef ENABLE_UNLIMITED_SKILL_SYSTEM
	PyModule_AddIntConstant(poModule, "SKILL_UNLIMITED_TIME", INT_MAX);
#endif
}