...
public:
	...
	typedef struct SPlayerStatus
	{
		...
		TItemData			aSSFItem[c_Special_ItemSlot_Count];
		TItemData			aSSAItem[c_Special_ItemSlot_Count];
	...
	enum EPartyRole
	{
		...
		PARTY_ROLE_ATTACKER_MONSTER,
		PARTY_ROLE_ATTACKER_STONE,
		PARTY_ROLE_ATTACKER_BOSS,
#endif
		PARTY_ROLE_MAX_NUM,
	};
...
public:
...
#ifdef ENABLE_AUTO_HUNT_SYSTEM
	void	OtoAvDurumAta(bool gelenDurum);
	bool	OtoAvDurumAl(){ return otoAvDurum; }
	void	OtoAvSaldiriAta(bool gelenDurum){ otoAvSaldir = gelenDurum; }
	bool	OtoAvSaldiriAl(){ return otoAvSaldir; }
	void	OtoAvOdakAta(bool gelenDurum){ otoAvOdak = gelenDurum; }
	bool	OtoAvOdakAl(){ return otoAvOdak; }
	TPixelPosition OtoAvBaslangicKonumuAl(){ return otoAvBaslangicKonumu; }
#endif
	...
	void	SetItemEvolution(TItemPos Cell, DWORD evolution);
	DWORD	GetItemEvolution(TItemPos Cell);
#endif
	...
	BYTE	GetItemAttributeType(TItemPos Cell, DWORD dwAttrSlotIndex);
	short	GetItemAttributeValue(TItemPos Cell, DWORD dwAttrSlotIndex);
	void	SendClickItemPacket(DWORD dwIID);
#ifdef ENABLE_SCP1453_EXTENTIONS
	bool	UseItemByVnum(DWORD dwVnum);
#endif
...
protected:
	...
	long	sonHedefBulMs;
	long	sonHedefBulMss;
	TPixelPosition otoAvBaslangicKonumu;
#endif
...
protected:
	...
	DWORD					m_dwNextTCPAutoPickTime;
#ifdef ENABLE_GAME_MASTER_UTILITY
	BYTE					m_bGameMasterLevel;
#endif
protected:
...
public:
	void	SetPB2GlobalChat(bool f);
	bool	IsPB2GlobalChat() { return m_bPB2GlobalChat; }
protected:
	bool	m_bPB2GlobalChat;
#endif // ENABLE_PB2_PREMIUM_SYSTEM
#ifdef ENABLE_AUTO_HUNT_SYSTEM
public:
	void SetLastAttackTime(DWORD dwTime) { sonHedefBulMs = dwTime; }
#endif
#ifdef ENABLE_ANTICHEAT
public:
	void* ptrti;
