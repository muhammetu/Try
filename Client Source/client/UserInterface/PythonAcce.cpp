...
#ifdef ENABLE_GOLD_LIMIT_REWORK
void CPythonAcce::AddMaterial(long long llRefPrice, BYTE bPos, TItemPos tPos)
{
...
#ifdef ENABLE_GOLD_LIMIT_REWORK
void CPythonAcce::RemoveMaterial(long long llRefPrice, BYTE bPos)
{
	if (bPos >= ACCE_WINDOW_MAX_MATERIALS)
		return;
...
{
#ifdef ENABLE_GOLD_LIMIT_REWORK
	return Py_BuildValue("L", CPythonAcce::Instance().GetPrice());
#else
