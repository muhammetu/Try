...
#ifndef APP_ENABLE_IMPORT_MODULE
...
PyObject* appShellExecute(PyObject* poSelf, PyObject* poArgs)
{
	...
	ShellExecute(0, "open", szName, 0, 0, SW_SHOWNORMAL);
	return Py_BuildNone();
}
...
void initapp()
{
...
#ifdef APP_ENABLE_IMPORT_MODULE
	PyModule_AddIntConstant(poModule, "APP_ENABLE_IMPORT_MODULE", true);
#else
	PyModule_AddIntConstant(poModule, "APP_ENABLE_IMPORT_MODULE", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DROP_DIALOG_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DROP_DIALOG_SYSTEM", 0);
#endif

#ifdef ENABLE_REFINE_MSG_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_MSG_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_MSG_REWORK", 0);
#endif

#ifdef ENABLE_HIGHLIGHT_ITEM
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_ITEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_SHOUT_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_SHOUT_REWORK", 0);
#endif

#ifdef ENABLE_CHANNEL_CHANGER_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_CHANNEL_CHANGER_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHANNEL_CHANGER_SYSTEM", 0);
#endif

#ifdef ENABLE_CHANNEL_INFO_UPDATE
	PyModule_AddIntConstant(poModule, "ENABLE_CHANNEL_INFO_UPDATE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHANNEL_INFO_UPDATE", 0);
#endif

#ifdef ENABLE_BEGINNER_ITEM_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_BEGINNER_ITEM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BEGINNER_ITEM_SYSTEM", 0);
#endif

#ifdef ENABLE_ANCIENT_ATTR_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_ANCIENT_ATTR_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ANCIENT_ATTR_SYSTEM", 0);
#endif

#ifdef ENABLE_CHEST_INFO_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_CHEST_INFO_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHEST_INFO_SYSTEM", 0);
#endif

#ifdef ENABLE_EMOJI_UTILITY
	PyModule_AddIntConstant(poModule, "ENABLE_EMOJI_UTILITY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EMOJI_UTILITY", 0);
#endif

#ifdef ENABLE_FAST_SWAP_ITEM
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_SWAP_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_SWAP_ITEM", 0);
#endif

#ifdef ENABLE_ITEM_GACHA_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_GACHA_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_GACHA_SYSTEM", 0);
#endif

#ifdef ENABLE_SHOP_PRICE_TYPE_ITEM
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_PRICE_TYPE_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_PRICE_TYPE_ITEM", 0);
#endif

#ifdef ENABLE_STATUS_UP_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_STATUS_UP_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_STATUS_UP_REWORK", 0);
#endif

#ifdef ENABLE_METINSTONE_ON_MINIMAP
	PyModule_AddIntConstant(poModule, "ENABLE_METINSTONE_ON_MINIMAP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_METINSTONE_ON_MINIMAP", 0);
#endif

#ifdef ENABLE_ADDITIONAL_INVENTORY
	PyModule_AddIntConstant(poModule, "ENABLE_ADDITIONAL_INVENTORY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ADDITIONAL_INVENTORY", 0);
#endif

#ifdef ENABLE_COSTUME_SWITCH_ITEM
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_SWITCH_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_SWITCH_ITEM", 0);
#endif

#ifdef ENABLE_POTION_AS_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_POTION_AS_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_POTION_AS_REWORK", 0);
#endif

#ifdef ENABLE_AS_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_AS_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AS_REWORK", 0);
#endif

#ifdef ENABLE_DETAILS_INTERFACE
	PyModule_AddIntConstant(poModule, "ENABLE_DETAILS_INTERFACE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DETAILS_INTERFACE", 0);
#endif

#ifdef ENABLE_CHARACTER_WINDOW_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_CHARACTER_WINDOW_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHARACTER_WINDOW_RENEWAL", 0);
#endif

#ifdef ENABLE_GUILD_WAR_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_WAR_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_WAR_REWORK", 0);
#endif

#ifdef ENABLE_SOULSTONE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SOULSTONE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SOULSTONE_SYSTEM", 0);
#endif

#ifdef ENABLE_SKILLBOOK_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SKILLBOOK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILLBOOK_SYSTEM", 0);
#endif

#ifdef ENABLE_EXTRA_SOCKET_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_EXTRA_SOCKET_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTRA_SOCKET_SYSTEM", 0);
#endif

#ifdef ENABLE_CUBE_PERCENT_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_CUBE_PERCENT_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CUBE_PERCENT_RENEWAL", 0);
#endif

#ifdef ENABLE_GLOBAL_MESSAGE_UTILITY
	PyModule_AddIntConstant(poModule, "ENABLE_GLOBAL_MESSAGE_UTILITY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GLOBAL_MESSAGE_UTILITY", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DS_GRADE_EPIC", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DS_GRADE_EPIC", 0);
#endif

#ifdef ENABLE_DS_GRADE_GODLIKE
	PyModule_AddIntConstant(poModule, "ENABLE_DS_GRADE_GODLIKE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DS_GRADE_GODLIKE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GROWTH_MOUNT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GROWTH_MOUNT_SYSTEM", 0);
#endif

#ifdef ENABLE_SIGN_PLUS_ITEMS
	PyModule_AddIntConstant(poModule, "ENABLE_SIGN_PLUS_ITEMS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SIGN_PLUS_ITEMS", 0);
#endif

#ifdef ENABLE_ALIGNMENT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_ALIGNMENT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ALIGNMENT_SYSTEM", 0);
#endif

#ifdef ENABLE_ATTR_ADDONS
	PyModule_AddIntConstant(poModule, "ENABLE_ATTR_ADDONS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ATTR_ADDONS", 0);
#endif

#ifdef ENABLE_POTION_ITEMS
	PyModule_AddIntConstant(poModule, "ENABLE_POTION_ITEMS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_POTION_ITEMS", 0);
#endif
...
#ifdef ENABLE_SNOWFALL_MODE
	PyModule_AddIntConstant(poModule, "ENABLE_SNOWFALL_MODE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SNOWFALL_MODE", 0);
#endif

#ifdef ENABLE_TEXTURE_MODE
	PyModule_AddIntConstant(poModule, "ENABLE_TEXTURE_MODE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TEXTURE_MODE", 0);
#endif

#ifdef ENABLE_ITEM_EVOLUTION_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_EVOLUTION_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_EVOLUTION_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_CHOOSE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_CHOOSE_SYSTEM", 0);
#endif

#ifdef ENABLE_INGAME_MALL_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_INGAME_MALL_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_INGAME_MALL_SYSTEM", 0);
#endif

#ifdef ENABLE_EXCHANGE_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXCHANGE_REWORK", 0);
#endif

#ifdef ENABLE_GUILD_LEADER_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_LEADER_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_LEADER_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_BOSS_ON_MINIMAP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BOSS_ON_MINIMAP", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DSS_ACTIVE_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DSS_ACTIVE_EFFECT", 0);
#endif
...
#ifdef ENABLE_HOUR_HISTORY_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_HOUR_HISTORY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HOUR_HISTORY_SYSTEM", 0);
#endif

#ifdef ENABLE_PERMA_ACCESSORY_ITEM
	PyModule_AddIntConstant(poModule, "ENABLE_PERMA_ACCESSORY_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PERMA_ACCESSORY_ITEM", 0);
#endif

#ifdef ENABLE_PARTY_ROLE_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_PARTY_ROLE_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PARTY_ROLE_REWORK", 0);
#endif

#ifdef ENABLE_WEB_LINK_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_WEB_LINK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WEB_LINK_SYSTEM", 0);
#endif

#ifdef ENABLE_MAP_ALGORITHM_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_MAP_ALGORITHM_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MAP_ALGORITHM_RENEWAL", 0);
#endif

#ifdef ENABLE_REFINE_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_REWORK", 0);
#endif

#ifdef ENABLE_BLEND_REWORK
	PyModule_AddIntConstant(poModule, "ENABLE_BLEND_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BLEND_REWORK", 0);
#endif

#ifdef ENABLE_REMOVE_SKILL_AFFECT
	PyModule_AddIntConstant(poModule, "ENABLE_REMOVE_SKILL_AFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REMOVE_SKILL_AFFECT", 0);
#endif

#if defined(ENABLE_MOB_AGGR_LVL_INFO)
	PyModule_AddIntConstant(poModule, "ENABLE_MOB_AGGR_LVL_INFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MOB_AGGR_LVL_INFO", 0);
#endif

#ifdef ENABLE_CUBE_RELOAD_FIX
	PyModule_AddIntConstant(poModule, "ENABLE_CUBE_RELOAD_FIX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CUBE_RELOAD_FIX", 0);
#endif

#ifdef ENABLE_CLEAR_CHAT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_CLEAR_CHAT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CLEAR_CHAT_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CLIENT_VERSION_UTILITY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CLIENT_VERSION_UTILITY", 0);
#endif

#ifdef ENABLE_EVENT_CALENDAR_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_EVENT_CALENDAR_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EVENT_CALENDAR_SYSTEM", 0);
#endif

#ifdef ENABLE_CHAT_STACK_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_STACK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_STACK_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_PET_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_PET_ITEM", 0);
#endif

#ifdef ENABLE_SPLIT_ITEMS_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SPLIT_ITEMS_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SPLIT_ITEMS_SYSTEM", 0);
#endif
...
#ifdef ENABLE_UNLIMITED_SKILL_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_UNLIMITED_SKILL_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_UNLIMITED_SKILL_SYSTEM", 0);
#endif

#ifdef ENABLE_COSTUME_EXTEND_TIME_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_EXTEND_TIME_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_EXTEND_TIME_SYSTEM", 0);
#endif

#ifdef ENABLE_PIN_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_PIN_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PIN_SYSTEM", 0);
#endif

#ifdef ENABLE_SKILL_BOOK_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_BOOK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILL_BOOK_SYSTEM", 0);
#endif

#ifdef ENABLE_CHAT_MODE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_MODE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_MODE_SYSTEM", 0);
#endif
...
#ifdef ENABLE_FONT_MODE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_FONT_MODE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FONT_MODE_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GOLD_LIMIT_REWORK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GOLD_LIMIT_REWORK", 0);
#endif

#ifdef ENABLE_UNBUG_CHARACTER_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_UNBUG_CHARACTER_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_UNBUG_CHARACTER_SYSTEM", 0);
#endif

#ifdef ENABLE_HWID_SECURITY_UTILITY
	PyModule_AddIntConstant(poModule, "ENABLE_HWID_SECURITY_UTILITY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HWID_SECURITY_UTILITY", 0);
#endif

#ifdef ENABLE_BAN_REASON_UTILITY
	PyModule_AddIntConstant(poModule, "ENABLE_BAN_REASON_UTILITY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BAN_REASON_UTILITY", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TEAM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TEAM_SYSTEM", 0);
#endif

#ifdef ENABLE_LANDRANK_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_LANDRANK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LANDRANK_SYSTEM", 0);
#endif

#ifdef ENABLE_REBORN_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_REBORN_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REBORN_SYSTEM", 0);
#endif

#ifdef ENABLE_MONIKER_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_MONIKER_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MONIKER_SYSTEM", 0);
#endif
...
#ifdef ENABLE_SKYBOX_OPTION_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SKYBOX_OPTION_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKYBOX_OPTION_SYSTEM", 0);
#endif

#ifdef ENABLE_EXP_INFO_TEXT
	PyModule_AddIntConstant(poModule, "ENABLE_EXP_INFO_TEXT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXP_INFO_TEXT", 0);
#endif

#ifdef ENABLE_DSS_RECHARGE_ITEM
	PyModule_AddIntConstant(poModule, "ENABLE_DSS_RECHARGE_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DSS_RECHARGE_ITEM", 0);
#endif

#ifdef ENABLE_TOOLTIP_DROP_INFORMATION
	PyModule_AddIntConstant(poModule, "ENABLE_TOOLTIP_DROP_INFORMATION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TOOLTIP_DROP_INFORMATION", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PENDANT_ATTRIBUTE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PENDANT_ATTRIBUTE_SYSTEM", 0);
#endif

#ifdef ENABLE_SAGE_SKILL
	PyModule_AddIntConstant(poModule, "ENABLE_SAGE_SKILL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SAGE_SKILL", 0);
#endif

#ifdef ENABLE_EXPERT_SKILL
	PyModule_AddIntConstant(poModule, "ENABLE_EXPERT_SKILL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXPERT_SKILL", 0);
#endif

#ifdef ENABLE_DSS_REFINE_ITEM
	PyModule_AddIntConstant(poModule, "ENABLE_DSS_REFINE_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DSS_REFINE_ITEM", 0);
#endif

#ifdef ENABLE_ARMOR_EVOLUTION_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_ARMOR_EVOLUTION_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ARMOR_EVOLUTION_SYSTEM", 0);
#endif

#ifdef ENABLE_LOTTERY_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_LOTTERY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LOTTERY_SYSTEM", 0);
#endif

#ifdef ENABLE_CHAT_FILTER
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_FILTER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_FILTER", 0);
#endif

#ifdef ENABLE_NEW_DUNGEON_TYPE
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_DUNGEON_TYPE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_DUNGEON_TYPE", 0);
#endif
...
#ifdef APP_VERSION
	PyModule_AddStringConstant(poModule, "VERSION", APP_VERSION);
#endif

#ifdef ENABLE_CLIENT_VERSION_UTILITY
	PyModule_AddStringConstant(poModule, "CLIENT_VERSION", CLIENT_VERSION);
#endif


#ifdef ENABLE_RANDOM_CHANNEL_SEL
	PyModule_AddIntConstant(poModule, "ENABLE_RANDOM_CHANNEL_SEL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RANDOM_CHANNEL_SEL", 0);
#endif

#ifdef ENABLE_CLEAN_DATA_IF_FAIL_LOGIN
	PyModule_AddIntConstant(poModule, "ENABLE_CLEAN_DATA_IF_FAIL_LOGIN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CLEAN_DATA_IF_FAIL_LOGIN", 0);
#endif

#ifdef ENABLE_PASTE_FEATURE
	PyModule_AddIntConstant(poModule, "ENABLE_PASTE_FEATURE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PASTE_FEATURE", 0);
#endif

#ifdef ENABLE_FULLSTONE_DETAILS
	PyModule_AddIntConstant(poModule, "ENABLE_FULLSTONE_DETAILS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FULLSTONE_DETAILS", 0);
#endif

#ifdef ENABLE_REFINE_PCT
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_PCT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_REFINE_PCT", 0);
#endif

#ifdef ENABLE_CHAT_EMOTION_BLOCK
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_EMOTION_BLOCK", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_EMOTION_BLOCK", 0);
#endif

#ifdef ENABLE_AFFECT_SHOWER_TOOLTIP_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_AFFECT_SHOWER_TOOLTIP_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AFFECT_SHOWER_TOOLTIP_RENEWAL", 0);
#endif

#ifdef ENABLE_HIGHLIGHT_TOOLTIP
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_TOOLTIP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HIGHLIGHT_TOOLTIP", 0);
#endif

#ifdef ENABLE_RACE_FLAG_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_RACE_FLAG_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RACE_FLAG_RENEWAL", 0);
#endif

#ifdef ENABLE_ANTIFLAG_TEXTLINE
	PyModule_AddIntConstant(poModule, "ENABLE_ANTIFLAG_TEXTLINE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ANTIFLAG_TEXTLINE", 0);
#endif

#ifdef ENABLE_FRIEND_ONLINE_NOTIFICATION
	PyModule_AddIntConstant(poModule, "ENABLE_FRIEND_ONLINE_NOTIFICATION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FRIEND_ONLINE_NOTIFICATION", 0);
#endif

#ifdef ENABLE_FAST_EXIT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_EXIT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_EXIT_SYSTEM", 0);
#endif

#ifdef ENABLE_VNUM_TOOLTIP_TEXT
	PyModule_AddIntConstant(poModule, "ENABLE_VNUM_TOOLTIP_TEXT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_VNUM_TOOLTIP_TEXT", 0);
#endif

#ifdef ENABLE_QUESTION_DLG_TIME_EXTENSION
	PyModule_AddIntConstant(poModule, "ENABLE_QUESTION_DLG_TIME_EXTENSION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_QUESTION_DLG_TIME_EXTENSION", 0);
#endif

#ifdef ENABLE_UNLIMITED_AUTOPOTION
	PyModule_AddIntConstant(poModule, "ENABLE_UNLIMITED_AUTOPOTION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_UNLIMITED_AUTOPOTION", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_LOGIN_DLG_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LOGIN_DLG_RENEWAL", 0);
#endif


#ifdef ENABLE_GOLD_INFO_TEXT
	PyModule_AddIntConstant(poModule, "ENABLE_GOLD_INFO_TEXT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GOLD_INFO_TEXT", 0);
#endif

#ifdef ENABLE_PVP_EFFECT
	PyModule_AddIntConstant(poModule, "ENABLE_PVP_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PVP_EFFECT", 0);
#endif

#ifdef ENABLE_SMITH_EFFECT
	PyModule_AddIntConstant(poModule, "ENABLE_SMITH_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SMITH_EFFECT", 0);
#endif

#ifdef ENABLE_AGGR_MONSTER_EFFECT
	PyModule_AddIntConstant(poModule, "ENABLE_AGGR_MONSTER_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AGGR_MONSTER_EFFECT", 0);
#endif

#ifdef ENABLE_GAME_MASTER_UTILITY
	PyModule_AddIntConstant(poModule, "ENABLE_GAME_MASTER_UTILITY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GAME_MASTER_UTILITY", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TARGET_BOARD_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TARGET_BOARD_RENEWAL", 0);
#endif

#ifdef ENABLE_HAIR_COSTUME_ATTRIBUTE
	PyModule_AddIntConstant(poModule, "ENABLE_HAIR_COSTUME_ATTRIBUTE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HAIR_COSTUME_ATTRIBUTE", 0);
#endif

#ifdef ENABLE_BODY_COSTUME_ATTRIBUTE
	PyModule_AddIntConstant(poModule, "ENABLE_BODY_COSTUME_ATTRIBUTE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BODY_COSTUME_ATTRIBUTE", 0);
#endif

#ifdef LIVE_SERVER
	PyModule_AddIntConstant(poModule, "LIVE_SERVER", 1);
#else
	PyModule_AddIntConstant(poModule, "LIVE_SERVER", 0);
#endif

#ifdef ENABLE_CHAT_STOP
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_STOP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_STOP", 0);
#endif

#ifdef ENABLE_SORT_INVENTORY_ITEM
	PyModule_AddIntConstant(poModule, "ENABLE_SORT_INVENTORY_ITEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SORT_INVENTORY_ITEM", 0);
#endif

#ifdef ENABLE_NEW_ACCESORY_ITEMS
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_ACCESORY_ITEMS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_ACCESORY_ITEMS", 0);
#endif

#ifdef ENABLE_ACC_STATUS_CHECHKUP
	PyModule_AddIntConstant(poModule, "ENABLE_ACC_STATUS_CHECHKUP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ACC_STATUS_CHECHKUP", 0);
#endif

#ifdef ENABLE_MODEL_RENDER_TARGET
	PyModule_AddIntConstant(poModule, "ENABLE_MODEL_RENDER_TARGET",	1);
	#ifdef USE_MODEL_RENDER_TARGET_UI
		PyModule_AddIntConstant(poModule, "USE_MODEL_RENDER_TARGET_UI", 1);
	#else
		PyModule_AddIntConstant(poModule, "USE_MODEL_RENDER_TARGET_UI",	0);
	#endif
	#ifdef USE_MODEL_RENDER_TARGET_TEXTTAIL
		PyModule_AddIntConstant(poModule, "USE_MODEL_RENDER_TARGET_TEXTTAIL", 1);
	#else
		PyModule_AddIntConstant(poModule, "USE_MODEL_RENDER_TARGET_TEXTTAIL", 0);
	#endif
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MODEL_RENDER_TARGET", 0);
	PyModule_AddIntConstant(poModule, "USE_MODEL_RENDER_TARGET_UI", 0);
	PyModule_AddIntConstant(poModule, "USE_MODEL_RENDER_TARGET_TEXTTAIL", 0);
#endif

#ifdef ENABLE_ATLAS_RENDER_OPTION
	PyModule_AddIntConstant(poModule, "ENABLE_ATLAS_RENDER_OPTION",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ATLAS_RENDER_OPTION",	0);
#endif

#ifdef ENABLE_GRAPHIC_OPTIMIZATION
	PyModule_AddIntConstant(poModule, "ENABLE_GRAPHIC_OPTIMIZATION", 1);
	#ifdef USE_GRAPHIC_OPTIMIZATION_TEST
		PyModule_AddIntConstant(poModule, "USE_GRAPHIC_OPTIMIZATION_TEST", 1);
	#else
		PyModule_AddIntConstant(poModule, "USE_GRAPHIC_OPTIMIZATION_TEST", 0);
	#endif
	#ifdef USE_GRAPHIC_OPTIMIZATION_EFFECT
		PyModule_AddIntConstant(poModule, "USE_GRAPHIC_OPTIMIZATION_EFFECT", 1);
	#else
		PyModule_AddIntConstant(poModule, "USE_GRAPHIC_OPTIMIZATION_EFFECT", 0);
	#endif
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GRAPHIC_OPTIMIZATION", 0);
	PyModule_AddIntConstant(poModule, "USE_GRAPHIC_OPTIMIZATION_TEST", 0);
	PyModule_AddIntConstant(poModule, "USE_GRAPHIC_OPTIMIZATION_EFFECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CAKRA_ITEM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CAKRA_ITEM_SYSTEM", 0);
#endif
#ifdef ENABLE_USE_ITEM_COUNT
	PyModule_AddIntConstant(poModule, "ENABLE_USE_ITEM_COUNT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_USE_ITEM_COUNT", 0);
#endif

#ifdef ENABLE_TELEPORT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_TELEPORT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TELEPORT_SYSTEM", 0);
#endif

#ifdef ENABLE_NEW_ATTR_PHEBIA
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_ATTR_PHEBIA", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_ATTR_PHEBIA", 0);
#endif

#ifdef ENABLE_SPAM_BOT_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_SPAM_BOT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SPAM_BOT_SYSTEM", 0);
#endif
#ifdef ENABLE_DISCORD_UTILITY
	PyModule_AddIntConstant(poModule, "ENABLE_DISCORD_UTILITY", 1);
	#ifdef USE_DISCORD_RPC_MODULE
		PyModule_AddIntConstant(poModule, "USE_DISCORD_RPC_MODULE", 1);
	#else
		PyModule_AddIntConstant(poModule, "USE_DISCORD_RPC_MODULE", 0);
	#endif
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DISCORD_UTILITY", 0);
	PyModule_AddIntConstant(poModule, "USE_DISCORD_RPC_MODULE", 0);
#endif

#ifdef ENABLE_CHAT_FILTER_OPTION
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_FILTER_OPTION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_FILTER_OPTION", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_GAME_OPTION_DLG_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GAME_OPTION_DLG_RENEWAL", 0);
#endif

#ifdef ENABLE_DAMAGE_DOT
	PyModule_AddIntConstant(poModule, "ENABLE_DAMAGE_DOT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DAMAGE_DOT", 0);
#endif // ENABLE_DAMAGE_DOT

#ifdef USE_LOADING_DLG_OPTIMIZATION
	PyModule_AddIntConstant(poModule, "USE_LOADING_DLG_OPTIMIZATION", 1);
#else
	PyModule_AddIntConstant(poModule, "USE_LOADING_DLG_OPTIMIZATION", 0);
#endif // USE_LOADING_DLG_OPTIMIZATION

#ifdef ENABLE_HIDE_BODY_PARTS
	PyModule_AddIntConstant(poModule, "ENABLE_HIDE_BODY_PARTS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_HIDE_BODY_PARTS", 0);
	...
	PyModule_AddIntConstant(poModule, "CHEQUE_MAX", 2000000000);
	PyModule_AddIntConstant(poModule, "GOLD_MAX", 10000000000LL);
#else
	...
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_HUNT_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_HUNT_SYSTEM", 0);
#endif
#ifdef ENABLE_PB2_PREMIUM_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_PB2_PREMIUM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PB2_PREMIUM_SYSTEM", 0);
#endif // ENABLE_PB2_PREMIUM_SYSTEM
#ifdef ENABLE_PB2_NEW_TAG_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_PB2_NEW_TAG_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PB2_NEW_TAG_SYSTEM", 0);
#endif // ENABLE_PB2_NEW_TAG_SYSTEM
#ifdef ENABLE_CHAT_COLOR_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_COLOR_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHAT_COLOR_SYSTEM", 0);
#endif // ENABLE_CHAT_COLOR_SYSTEM
#ifdef ENABLE_NAME_CHANGE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_NAME_CHANGE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NAME_CHANGE_SYSTEM", 0);
#endif // ENABLE_NAME_CHANGE_SYSTEM
#ifdef ENABLE_LOVE_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_LOVE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_LOVE_SYSTEM", 0);
#endif // ENABLE_LOVE_SYSTEM

#ifdef ENABLE_WORD_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_WORD_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WORD_SYSTEM", 0);
#endif // ENABLE_WORD_SYSTEM
#ifdef ENABLE_FAST_CHEQUE_TRANSFER
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_CHEQUE_TRANSFER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_CHEQUE_TRANSFER", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SEBNEM_ITEM_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SEBNEM_ITEM_SYSTEM", 0);
#endif
#ifdef ENABLE_MULTIFARM_BLOCK
