...
#ifdef ENABLE_CHAT_STOP
	typedef std::list<TStoppedChat> TStoppedChatList;
#endif
...
public:
	...
	// Chat
#ifdef ENABLE_CHAT_STOP
	void AppendChat(int iType, const char* c_szChat, DWORD appendTime = -1);
#else
	void AppendChat(int iType, const char* c_szChat);
#endif
	...
	void GetChatStack(BYTE index, std::string& stack);
...
#ifdef ENABLE_CHAT_STOP
	TStoppedChatList					m_StoppedChatList;
#endif
