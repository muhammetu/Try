...
public:
	bool IsActivateWnd() const { return m_isActivateWnd; };
	bool IsMinimalizeWnd() const { return m_isMinimizedWnd; };
protected:
	CTimer m_timer;
...
#ifdef ENABLE_EVENT_SYSTEM
	CPythonGameEvents			m_pyGameEvents;
#endif
#ifdef ENABLE_CHANGELOOK_SYSTEM
...
#endif
#ifdef ENABLE_GROWTH_MOUNT_SYSTEM
	CPythonSkillMount			m_pySkillMount;
#endif
#ifdef ENABLE_ACCE_SYSTEM
	CPythonAcce					m_pyAcce;
#endif
#ifdef ENABLE_MODEL_RENDER_TARGET
	CRenderTargetManager		m_kRenderTargetMgr;
	CPythonRenderTarget			m_pyRenderTarget;
#endif

#ifdef ENABLE_DISCORD_UTILITY
	CDiscordManager				m_kDiscordManager;
#endif
