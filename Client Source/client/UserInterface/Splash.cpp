...
void CSplash::Init()
{
    ...
    if(hUser32) g_pSetLayeredWindowAttributes = (lpfnSetLayeredWindowAttributes)
...
HWND CSplash::RegAndCreateWindow()
{
    ...
    DWORD nScrWidth  = rectWork.right - rectWork.left;
    DWORD nScrHeight = rectWork.bottom - rectWork.top;
...
bool CSplash::MakeTransparent()
{
    ...
    if(m_hwnd && g_pSetLayeredWindowAttributes && m_colTrans )
    {
        ...
        g_pSetLayeredWindowAttributes(m_hwnd, m_colTrans, 0, 1);
    }    
    return TRUE;
}
