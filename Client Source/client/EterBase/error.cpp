...
void make_minidump(EXCEPTION_POINTERS* e)
{
	...
	// filename
	std::string filename = folder + "\\"s + "vatansever_"s + std::to_string(METIN2_GET_VERSION()) + "_"s + timefmt.str() + ".dmp";
	...
	// MessageBox(NULL, errMsg.c_str(), "Metin2Client", MB_ICONSTOP);
