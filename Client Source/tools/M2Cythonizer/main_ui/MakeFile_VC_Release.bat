...
SET VSINSTALLDIR=C:\Program Files\Microsoft Visual Studio\2022\Community\Community
SET VCINSTALLDIR=C:\Program Files\Microsoft Visual Studio\2022\Community\Community\VC
...
cl /O2 /Ob1 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "USE_LOD" /D "_DISTRIBUTE" /D "_VC80_UPGRADE=0x0710" /D "_MBCS" /GF /FD /EHsc /MT /Gy /FAcs /W3 /nologo /c /MP8 *.c
lib /out:.\uiscriptlib.lib *.obj
exit
